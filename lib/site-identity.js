...
export const ROOT_META_TITLE = `${ENTITY_LABEL} | AI가 당신의 회사를 정확히 알고 있을까요?`;
export const ROOT_META_DESCRIPTION =
  `${ENTITY_LABEL}는 ChatGPT, Gemini, Perplexity가 기업 정보를 어떻게 설명하는지 진단하고, 공식 웹사이트와 AI Profile Page를 통해 AI의 1차 출처를 강화하는 서비스입니다.`;

export const AI_PROFILE_META_TITLE = `${ENTITY_LABEL} | 공식 AI Profile Page`;
export const AI_PROFILE_META_DESCRIPTION =
  `${ENTITY_LABEL}는 웹사이트를 생성형 AI가 얼마나 정확히 이해하는지 진단하고, 공식 웹사이트를 AI의 1차 출처로 만들기 위한 AI Profile Page를 설계·제작하는 서비스입니다.`;
