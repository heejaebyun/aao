...
export const AI_PROFILE_META_DESCRIPTION =
  `${ENTITY_LABEL} is an AI search optimization service. Official AI Profile with structured company facts, official-source policy, and primary services for AI-readable discovery.`;
