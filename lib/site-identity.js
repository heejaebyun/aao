...
export const PUBLIC_MARKETING_DESCRIPTION =
  `${ENTITY_LABEL} is an AI search optimization service that helps companies make their official websites the primary source for AI answers.`;

export const ROOT_META_TITLE = `${ENTITY_LABEL} | AI search optimization service`;
...
export const AI_PROFILE_META_DESCRIPTION =
  `Official AI Profile for ${ENTITY_LABEL}. Structured company facts, official-source policy, and primary services for AI-readable discovery.`;
