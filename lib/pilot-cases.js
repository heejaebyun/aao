...
export const FEATURED_PILOT_CASES = [
  {
    ...
    headline: "메인 랜딩 50점, /ai-profile 57점으로 실측됐고 구조화된 정적 페이지가 실제로 +7점 개선을 만들었습니다.",
    summary:
      "AAO 자체 사이트를 첫 파일럿 케이스로 사용합니다. 2026년 3월 7일 실측 기준 메인 랜딩은 50점, /ai-profile은 57점으로 확인됐습니다. 현재 uplift는 +7점이며, canonical/출처성/엔티티 강화를 더 해야 목표 91점에 접근할 수 있습니다.",
    problemPoints: [
      "AAO 브랜드 엔티티가 아직 약하고 다른 의미와 충돌합니다.",
      "메인 랜딩 페이지는 제품 정의보다 카피 비중이 높아 PACP가 8점에 머뭅니다.",
    ...
    evidence: [
      {
        ...
        value: "메인 랜딩 50점/100 (2026-03-07)",
      },
      {
        label: "Measured After",
        value: "/ai-profile 57점/100 (2026-03-07)",
      },
      {
        label: "Measured Lift",
        value: "+7점",
