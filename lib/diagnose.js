...
function normalizeCustomerSummary(summary, overallScore, overallScoreSource, responseSource) {
  ...
  const hasExpectedScore =
    Number.isFinite(Number(summary?.expected_score_after)) &&
    Number(summary?.expected_score_after) > overallScore;
  ...
  return {
    ...
    expected_score_after: hasExpectedScore ? clampNumber(summary?.expected_score_after, overallScore, 100) : fallbackScore,
